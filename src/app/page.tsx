            ...
            <div>
              ...
              <FadeIn delay={0.22}>
                <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light">
                  ...
                  <p>「必要か必要ではないか」の判断ではなく、「手に取ったときに心が動く」もの——。暮らしが少し楽しくなるもの、心が潤うものとの出逢いを大切に、店主がセレクトしたものをご用意いたしております。</p>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          ...
          <FadeIn delay={0.22}>
            <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light max-w-2xl mx-auto">
              <p>フランス在住のバイヤーから届くアンティークやヴィンテージの食器・雑貨と、彫金技術を習得した店主が制作する手しごとのアクセサリーを扱うセレクトショップです。蚤の市でお気に入りを捜すような気分でお楽しみください。</p>
              <p>食器や雑貨のほか、シルバー925や天然石を使った手作りアクセサリーも取り扱っています。自分へのご褒美に、大切な方へのギフトに。</p>

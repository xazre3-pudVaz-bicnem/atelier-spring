...
export const metadata: Metadata = {
  ...
  description:
    "東京都調布市国領町にあるアンティークやヴィンテージ雑貨と手作りアクセサリーのセレクトショップ。フランス在住のバイヤーから届くアンティーク食器・ヴィンテージ雑貨と、彫金技術を習得した店主が制作する一点物アクセサリー。調布・国領でときめく品をお探しなら、Atelier♡Springへ。",
};
...
const categories = [
  {
    ...
    desc: "アルビの蚤の市などからフランス在住のバイヤーが見つけたアンティークやヴィンテージの食器・雑貨。大量生産品にはない経年美と個性が魅力の一点物。",
    showBase: false,
  },
  {
    en: "Selected Goods",
    ja: "店主がセレクトした雑貨",
    desc: "心ときめく物との出逢いを大切に。店主がひとつひとつ選びました。",
    showBase: false,
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    a: "はい。フランス在住のバイヤーがアルビの蚤の市などで見つけたアンティークやヴィンテージの食器・雑貨を取り揃えています。量産品にはない経年美が魅力の一点物です。",
  },
  {
    q: "アクセサリーはどのような作品ですか？",
  ...
  {
    q: "オンラインで購入できますか？",
    a: "アクセサリーのみBASEオンラインショップにてお買い求めいただけます。",
  },
  {
    q: "店舗はどこにありますか？",
            ...
            <div>
              ...
              <FadeIn delay={0.22}>
                <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light">
                  <p>Atelier♡Spring（アトリエ♡スプリング）は、東京都調布市国領町にある小さなセレクトショップです。フランス在住のバイヤーから届くアンティークやヴィンテージの食器や雑貨と、彫金技術を習得した店主が手がける一点物のアクセサリーを取り揃えています。</p>
                  <p>「必要か必要ではないか」の判断ではなく、「手に取ったときに心が動く」もの——。暮らしが少し楽しくなるもの、心が潤うものとの出逢いを大切に、お客様にときめきをお届けするための品々をご用意しています。</p>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div>
              ...
              <FadeIn delay={0.12}>
                <h2 className="font-cormorant text-4xl lg:text-5xl text-[#3A3028] font-light leading-snug mb-8">
                  アンティークやヴィンテージとの、<br /><span className="italic">ときめく出逢い。</span>
                </h2>
              </FadeIn>
              <FadeIn delay={0.22}>
                <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light">
                  <p>アルビの蚤の市などでフランス在住のバイヤーが見つけたアンティークやヴィンテージの食器には、大量生産品にはない経年の美しさがあります。使い込まれた貫入（かんにゅう）のひび、金彩のわずかな退色、手描きの絵付け——それぞれが、フランスの暮らしの中で積み重なった日々の美しさです。</p>
                  <p>フランス在住のバイヤーが見つけた、本当に心を動かされる一点物だけをお届けしています。量産品では決して出せない経年の味わいと個性を、調布・国領から。</p>
                </div>
              </FadeIn>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <FadeIn delay={0.22}>
                <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light">
                  <p>Atelier♡Springのアクセサリーのほとんどが、彫金技術を習得した店主の手しごとによるものです。シルバー925や天然石を素材に、薔薇のモチーフなど心ときめくアクセサリーを一つひとつ丁寧に制作しています。</p>
                  <p>割れてしまったアンティーク陶磁器を使ったリメイクアクセサリーもほとんどが一点物。さまざまな作品を作成しております。</p>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          ...
          <FadeIn delay={0.22}>
            <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light max-w-2xl mx-auto">
              <p>フランス在住のバイヤーから届くアンティークやヴィンテージの食器・雑貨と、彫金技術を習得した店主が制作する手しごとのアクセサリーを扱うセレクトショップです。お客様に「ときめき」をお届けするための品々をご用意しています。</p>
              <p>食器や雑貨のほか、シルバー925や天然石を使った手作りアクセサリーも取り扱っています。自分へのご褒美に、大切な方へのギフトに。世界でひとつの品との出逢いをお楽しみください。</p>

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light">
                ...
                <p>
                  フランス在住の仕入れ担当がアルビの蚤の市などを巡り見つけたアンティーク・ヴィンテージの品々に加え、店主がお客様にときめきを届けるためにセレクトした雑貨も取り揃えています。量産品には出せない一点物の美しさ、経年が育んだ味わい——それがAtelier♡Springのセレクトです。
                </p>
                <p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div>
              ...
              <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light">
                ...
                <p>
                  「これをつけたら気分が上がる」——そんなときめきを大切に、素材と向き合いながら一つひとつ丁寧に仕上げています。陶器だけにとらわれず、彫金技術を活かしたさまざまな素材の作品を制作し続けています。
                </p>
                <p>

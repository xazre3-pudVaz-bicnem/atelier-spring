          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light">
                ...
                <p>
                  フランス在住のバイヤーがアルビの蚤の市やブロカントで見つけたアンティークやヴィンテージの品々に加え、店主がセレクトした雑貨類も取り揃えております。
                </p>
                <p>
                  調布・国領の大人可愛い小さなショップで、あなただけの「ときめく一点」との出逢いをお待ちしています。
                </p>
                <p>
                  なお、BASEオンラインショップではアクセサリーのみを販売しております。アンティークやヴィンテージの雑貨類は店舗のみの取り扱いとなっております。
                </p>
              </div>
            </div>
            ...
            {[
              {
                num: "01",
                title: "ときめきの一点物",
                body: "「必要か必要ではないか」の判断ではなく、心が潤うか——お客様に「ときめき」をご提供させていただく為に店主がセレクトしております。",
              },
              {
                num: "02",
                title: "手しごとの温もり",
                body: "彫金技術を学んだ店主が一つひとつ手がけるアクセサリー。量産品にはない、手仕事の温もりがあります。",
              },
              {
                num: "03",
                title: "物語のある品",

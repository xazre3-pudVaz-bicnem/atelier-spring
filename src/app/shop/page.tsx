...
const categories = [
  ...
  },
  {
    en: "Selected Goods",
    ja: "店主がセレクトした雑貨",
    desc: "お客様に「ときめき」をお届けするために、店主がひとつひとつ厳選した雑貨。フランスの暮らしから生まれた、置くだけで空間が変わる品々。心ときめく物との出逢いを大切に。店主がひとつひとつえらびました。",
  },
  {
      ...
      <section className="py-16 lg:py-24 bg-[#FAF8F5]">
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          ...
          <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light max-w-2xl mx-auto">
            <p>
              アルビの蚤の市などからフランス在住の仕入れ担当が見つけたアンティークやヴィンテージの食器・雑貨に加え、店主がお客様に「ときめき」をお届けするためにセレクトした雑貨も取り揃えています。
            </p>
            <p>

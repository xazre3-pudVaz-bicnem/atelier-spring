...
export const metadata: Metadata = {
  ...
  description:
    "調布のセレクトショップAtelier♡Springのオンラインショップ。フランス在住のバイヤーから届くアンティークやヴィンテージの食器・雑貨と、彫金技術を習得した店主が制作する手作りアクセサリーをBASEにてご購入いただけます。",
};
      ...
      <section className="pt-32 lg:pt-44 pb-16 lg:pb-24 bg-[#F0EBE3]">
        <div className="max-w-6xl mx-auto px-6 lg:px-10 text-center">
          ...
          <p className="text-[13px] text-[#5C4A3A] font-light leading-loose max-w-xl mx-auto">
            フランス在住のバイヤーから届くアンティークやヴィンテージの食器・雑貨と、彫金技術を習得した店主が制作する手作りアクセサリーを取り揃えています。<br />
      ...
      <section className="py-16 lg:py-24 bg-[#FAF8F5]">
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          ...
          <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light max-w-2xl mx-auto">
            <p>
              アルビの蚤の市などからフランス在住のバイヤーが見つけたアンティークやヴィンテージの食器・雑貨に加え、店主がセレクトした雑貨類も取り揃えております。
            </p>
            <p>
              アクセサリーは、彫金技術を習得した店主がシルバー925や天然石を使って制作した一点物。薔薇のモチーフや、割れてしまったアンティーク陶磁器を使ったリメイク作品など、陶器だけにとらわれない多彩な作品を手がけています。
            </p>
            <p>

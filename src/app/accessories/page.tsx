      ...
      <section className="py-20 lg:py-28 bg-[#FAF8F5]">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
          ...
          <div className="space-y-5 text-[13px] lg:text-[14px] leading-loose text-[#5C4A3A] font-light text-left max-w-2xl mx-auto">
            <p>
              Atelier♡Springのアクセサリーのほとんどが、彫金技術を習得した店主の手しごとによるものです。シルバー925や天然石を素材に、薔薇のモチーフなど心ときめくアクセサリーを一つひとつ丁寧に制作しています。
            </p>
            <p>
              割れてしまったアンティーク陶磁器を使ったリメイクアクセサリーはほとんどが一点物。さまざまな作品を作成しております。お客様の宝物になるように、そんな願いを込めて一点一点丁寧に制作しています。
            </p>
            <p>
            ...
            {[
              {
                step: "Step 01",
                title: "素材との出逢い",
                desc: "シルバー925、天然石、割れてしまったアンティークやヴィンテージの陶磁器、などからインスピレーションを得て、制作が始まります。",
              },
              {
                step: "Step 02",
                title: "彫金技術で形にする",
